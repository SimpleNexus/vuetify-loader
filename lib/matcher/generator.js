...
const directives = Object.keys(require('vuetify2/es5/directives'))
  .filter(val => val !== 'default')

const dir = dirname(require.resolve('vuetify2/es5/components'))

const components = new Map()
// readdirSync(dir).forEach(group => {
//   if (!statSync(join(dir, group)).isDirectory()) return

//   const component = require(`vuetify2/es5/components/${group}`).default
